...
public class ByteArrayToFromString {
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String str3 = new String(array3, Charset.defaultCharset());
		String str4 = new String(array3, "UTF-8");
		...
		System.out.println(str5); // MS949 -> MS949(깨짐)
		System.out.println(str6); // UTF-8 -> UTF-8(깨짐)
